...
public class DingCallbackCrypto {
    ...
    private static void RemoveCryptographyRestrictions() throws Exception {
        ...
        if (jceSecurity != null) {
            ...
            PermissionCollection defaultPolicy =
                (PermissionCollection)getFieldValue(jceSecurity, "defaultPolicy", (Object)null,
            ...
            if (cryptoAllPermission != null) {
                Permission permission =
                    (Permission)getFieldValue(cryptoAllPermission, "INSTANCE", (Object)null, Permission.class);
